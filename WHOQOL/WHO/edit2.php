...
<div class="container shadow my-5">
    <div class="row justify-content-center">
        <div class="col-md-6 p-5" style="background: linear-gradient(to top, rgba(0, 0, 0, 0.8) 50%, rgba(0, 0, 0, 0.8) 50%);">
            <h1 class="display-6 fw-bolder mb-5" style="color: white; font-weight: bold;">Edit Profile</h1>
            ...
            <div class="form-group">
            <label for="password_hint" style="color: white; font-weight: bold;" value="<?php echo $password_hint; ?>">DOB:</label>
