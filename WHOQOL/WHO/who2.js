...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function showQuestion() {
    ...
    function showResult() {
      ...
      if (ph1 <= 14) {
        physicalHealthScore.textContent = `Physical Health Score: ${ph1}/35     - Low`;
      } else if (ph1 <= 25 && ph1>14) {
        physicalHealthScore.textContent = `Physical Health Score: ${ph1}/35     - Moderate`;
      } else {
        physicalHealthScore.textContent = `Physical Health Score: ${ph1}/35         - High`;
      }
      // psychologicalHealthScore.textContent = Psychological Health Score: ${mh1};
      if (mh1 <= 12) {
        psychologicalHealthScore.textContent = `Psychological Health Score: ${mh1}/30     - Low`;
      } else if (mh1 <= 18 && mh1>12) {
        psychologicalHealthScore.textContent = `Psychological Health Score: ${mh1}/30     - Moderate`;
      } else {
        psychologicalHealthScore.textContent = `Psychological Health Score: ${mh1}/30     - High`;
      }
      // socialHealthScore.textContent = Social Health Score: ${sh1};
      if (sh1 <= 6) {
        socialHealthScore.textContent = `Social Health Score: ${sh1}/15     - Low`;    
      } else if (sh1 <= 12 && sh1>6) {
        socialHealthScore.textContent = `Social Health Score: ${sh1}/15     - Moderate`;
      } else {
        socialHealthScore.textContent = `Social Health Score: ${sh1}/15     - High`;    
      }
      // environmentalHealthScore.textContent = Environmental Health Score: ${eh1};
      if (eh1 <= 16) {
        environmentalHealthScore.textContent = `Environmental Health Score: ${eh1}/40     - Low`;
      } else if (eh1 <= 24 && eh1 >16) {
        environmentalHealthScore.textContent = `Environmental Health Score: ${eh1}/40     - Moderate`;    
      } else {
        environmentalHealthScore.textContent = `Environmental Health Score: ${eh1}/40     - High`;    
      }
      ...
      else if(totalScore>24 && totalScore<48)
      {
    ...
    nextBtn.addEventListener("click", selectOptionAndMoveToNext);
