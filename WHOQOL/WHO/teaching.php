...
<body>
    ...
    <div class="navbar">
        ...
        if (isset($_SESSION["emp_id"]) || !isset($_SESSION["emp_id"])) {
            ...
            $assistantTeachingData = fetchAndCalculateAverageByDesignationAndUniversityRole($conn, 'Teaching Assistant(T.A.)', 'teaching');
            $age1930Data = fetchAndCalculateAverageByAgeRange($conn, 19, 30,"teaching");
    $age3140Data = fetchAndCalculateAverageByAgeRange($conn, 31, 40,"teaching");
    $age4150Data = fetchAndCalculateAverageByAgeRange($conn, 41, 50,"teaching");
    $age5160Data = fetchAndCalculateAverageByAgeRange($conn, 51, 60,"teaching");
    $age60plusData = fetchAndCalculateAverageByAgeRange($conn, 61, PHP_INT_MAX,"teaching");
    ...
    echo "<script>let age60plusData = " . json_encode($age60plusData) . ";</script>";
            ...
            echo "<script>let assistantTeachingData= " . json_encode($assistantTeachingData) . ";</script>";
    ...
    ?>
     <?php echo "<h1 style='color: white; text-align: center; font-size: 1.5em;'>Analysis of Teaching Staff</h1>"?><br><br>
...
<div class="chart-container2">
       <?php echo "<h2 style='color: white; text-align: center; font-size: 1.5em;'>Pie Chart - Health Scores Overall</h2> <h2 style='color: white; text-align: center; white-space: nowrap; font-size: 1.5em;'>Grouped Bar Chart - Health Scores by Gender</h2>"; ?>
        ...
        <?php echo "<h2 style='color: white; text-align: center; font-size: 1.5em;'>Grouped Bar Chart - Health Scores by Teaching Role</h2>"?>
...
<br><br>
        ...
        <script src="drawteaching.js"></script>
    </body>
    </html>